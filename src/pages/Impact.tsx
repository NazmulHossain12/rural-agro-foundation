...
import { Quote, TrendingUp, Users, Leaf, Apple, Shield, ArrowUpRight } from "lucide-react";
...
const metrics = [
  { value: "50,000+", label: "Farmers Trained", change: "+25% from last year" },
  { value: "250+", label: "Villages Reached", change: "Across 15 districts" },
  { value: "10,000+", label: "Hectares Improved", change: "Sustainable practices" },
...
const stories = [
  {
    ...
    quote: "The training changed everything for my family. I now grow vegetables year-round and have enough to sell at the market. My children no longer go hungry.",
  ...
  },
  {
    ...
    quote: "Climate-smart techniques helped me save my crops during the floods. I learned to adapt and now help other farmers in my village do the same.",
    outcome: "Reduced crop losses by 60%, became a community trainer",
  },
];

const sdgAlignments = [
  { number: 1, title: "No Poverty", icon: TrendingUp, description: "Economic empowerment through agriculture" },
  { number: 2, title: "Zero Hunger", icon: Apple, description: "Food security and nutrition programs" },
  { number: 5, title: "Gender Equality", icon: Users, description: "Women farmer empowerment initiatives" },
  { number: 13, title: "Climate Action", icon: Leaf, description: "Climate-resilient farming practices" },
];
  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-primary-foreground/80">
              Measurable, transparent outcomes that demonstrate how we're transforming rural communities across Bangladesh.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="text-primary font-semibold text-sm uppercase tracking-wide">By The Numbers</span>
      ...
      <section className="py-16 md:py-24 bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="text-primary font-semibold text-sm uppercase tracking-wide">Voices from the Field</span>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4 font-serif">
              Success Stories
            </h2>
            <p className="text-muted-foreground">
              ...
              >
                ...
                <div className="p-6 md:p-8">
                  ...
                  <div className="border-t border-border pt-4">
                    ...
                    <div className="text-muted-foreground text-sm mb-2">{story.location}</div>
      ...
      <section className="py-16 md:py-24 bg-muted">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="text-primary font-semibold text-sm uppercase tracking-wide">In The Field</span>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4 font-serif">
              Photo Gallery
            </h2>
          </div>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="text-primary font-semibold text-sm uppercase tracking-wide">Global Goals</span>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4 font-serif">
              SDG Alignment
            </h2>
            <p className="text-muted-foreground">
